...
<body>
        ...
        <nav>
            ...
            <div class="bottom__navbar">
                <ul>
                    ...
                    <li>
                        <a class="active" href="/about">OVER MBO UTRECHT</a>
                    </li>
                    <li>
    ...
    <section class="about_landing">
        ...
        <div class="grid-container">
            <div class="grid-item">
                <h4>MBO Utrecht</h4>
                <p>MBO Utrecht wil jou helpen in de ontwikkeling van student tot zelfbewuste professional. Wij geven jou meer dan een opleiding en leren je meer dan een vak. Er is veel aandacht voor de ontwikkeling van talent, arbeidsvaardigheden, ondernemend gedrag, maatschappelijke betrokkenheid, respect voor elkaar en burgerschap. </p>
            </div>
            <div class="grid-item">
