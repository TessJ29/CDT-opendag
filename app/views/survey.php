...
<body>
    ...
    <div class="survey-form">
        ...
        <div class="step-content" data-step="2">
            <form class="survey-form" action="/survey/create" method="post">
                <div class="fields">
                    <label for="Answer">
        ...
        <div class="step-content" data-step="3">
            <form class="survey-form" action="/survey/create" method="post">
                <div class="fields">
                    ...
                    <div class="rating">
                        <input type="radio" name="Answer" id="radio6" value="1">
                        <label for="radio6">1</label>
                        <input type="radio" name="Answer" id="radio7" value="2">
                        <label for="radio7">2</label>
                        <input type="radio" name="Answer" id="radio8" value="3">
                        <label for="radio8">3</label>
                        <input type="radio" name="Answer" id="radio9" value="4">
                        <label for="radio9">4</label>
                        <input type="radio" name="Answer" id="radio10" value="5">
        ...
        <div class="step-content" data-step="4">
            <form class="survey-form" action="/survey/create" method="post">
                <div class="fields">
                    ...
                    <div class="rating">
                        <input type="radio" name="Answer" id="radio11" value="1">
                        <label for="radio11">1</label>
                        <input type="radio" name="Answer" id="radio12" value="2">
                        <label for="radio12">2</label>
                        <input type="radio" name="Answer" id="radio13" value="3">
                        <label for="radio13">3</label>
                        <input type="radio" name="Answer" id="radio14" value="4">
                        <label for="radio14">4</label>
                        <input type="radio" name="Answer" id="radio15" value="5">
        ...
        <div class="step-content" data-step="5">
            <form class="survey-form4" action="/survey/create" method="post">
                <div class="fields">
                    <p>Bent u voldoende geinformeerd?</p>
                    <div class="rating">
                        <input type="radio" name="Answer" id="radio16" value="1">
                        <label for="radio16">1</label>
                        <input type="radio" name="Answer" id="radio17" value="2">
                        <label for="radio17">2</label>
                        <input type="radio" name="Answer" id="radio18" value="3">
                        <label for="radio18">3</label>
                        <input type="radio" name="Answer" id="radio19" value="4">
                        <label for="radio19">4</label>
                        <input type="radio" name="Answer" id="radio20" value="5">
        ...
        <div class="step-content" data-step="6">
            <form class="survey-form5" action="/survey/create" method="post">
                <div class="fields">
                    <p>Heeft u wat gehad aan deze open dag?</p>
                    <div class="rating">
                        <input type="radio" name="Answer" id="radio21" value="1">
                        <label for="radio21">1</label>
                        <input type="radio" name="Answer" id="radio22" value="2">
                        <label for="radio22">2</label>
                        <input type="radio" name="Answer" id="radio23" value="3">
                        <label for="radio23">3</label>
                        <input type="radio" name="Answer" id="radio24" value="4">
                        <label for="radio24">4</label>
                        <input type="radio" name="Answer" id="radio25" value="5">
        ...
        <div class="step-content" data-step="7">
            ...
            <div class="buttons">
                ...
                <a href="#" class="btn" data-set-step="8">Versturen</a>
            </div>
        </div>
        <!-- Data step page 8 -->
        <div class="step-content" data-step="8">
            <p>Dank u wel voor het invullen van het formulier.</p>
            <a href="http://www.opendag-mbo.local/index.php" class="btn">Terug naar start</a>
        </div>
        </form>
    </div>
