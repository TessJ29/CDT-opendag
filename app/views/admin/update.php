                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <input type="text" class="form-control" name="usersName" value="<?= $data["row"]->usersName ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label for="usersEmail"  class="form-label">Email:</label>
                                    <input type="text" class="form-control" name="usersEmail" value="<?= $data["row"]->usersEmail ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label for="usersLastname"  class="form-label">Achternaam:</label>
                                    <input type="text" class="form-control" name="usersLastname" value="<?= $data["row"]->usersLastname ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>
