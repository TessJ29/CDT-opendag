    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <input type="hidden" name="type" value="register">
             <label for="usersName" class="form-label">Naam:</label>
             <input name="usersName" type="text" class="form-control" placeholder="Full name...">
             ...
             <input name="usersUid" type="text" class="form-control" placeholder="Username...">
